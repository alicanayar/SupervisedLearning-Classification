...
from torch.nn import BCELoss, MSELoss,BCEWithLogitsLoss    #search loss function
...
class CSVDataset(Dataset):
    ...
    def __init__(self, path):
        ...
        #columns = ['PassengerId', 'Name', 'Survived', 'Pclass', 'Sex', 'Age', 'SibSp']
        columns = ['Age','Sex', 'Pclass', 'SibSp', 'Survived']
        df = df_[columns]
